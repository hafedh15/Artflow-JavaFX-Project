...
public class Profil implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        // Check if cardsContainer is properly injected
        if (cardsContainer == null) {
            System.err.println("ERROR: cardsContainer is null. FXML injection failed.");
            return;
        }

        System.out.println("CardsContainer found, proceeding to load reservations");
    ...
    private void loadReservations() {
        ...
        try {
            ...
            if (reservations.isEmpty()) {
                ...
                emptyLabel.setStyle("-fx-background-color: #eeeeee; -fx-padding: 20;");
