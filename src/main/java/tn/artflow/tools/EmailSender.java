...
/**
 * Service professionnel d'envoi d'emails pour l'application Artflow.
...
public class EmailSender {
    ...
    // Configuration email
    private static final String SENDER_EMAIL = "skanderselmi19@gmail.com";
    private static final String SENDER_PASSWORD = "lism tnzs fqll lfsw";
    private static final String SENDER_NAME = "Artflow";
    ...
    public static void sendLoginNotification(String toEmail, String prenom) {
        ...
        try {
            ...
            message.setSubject("Nouvelle connexion à votre compte Artflow");
    ...
    public static void sendVerificationEmail(String toEmail, String verificationCode) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(SENDER_EMAIL, SENDER_NAME));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
            message.setSubject("Vérification de votre compte Artflow");
    ...
    public static void sendPasswordResetEmail(String toEmail, String resetCode, String prenom) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(SENDER_EMAIL, SENDER_NAME));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
            message.setSubject("Réinitialisation de votre mot de passe Artflow");
    ...
    public static void sendWelcomeEmail(String toEmail, String prenom) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(SENDER_EMAIL, SENDER_NAME));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
            message.setSubject("Bienvenue sur Artflow !");
    ...
    private static String createLoginEmailTemplate(String prenom, String dateTime) {
        return "<!DOCTYPE html>"
                ...
                + "            <h1 style='color: white; margin: 0;'>Artflow</h1>"
                + "        </div>"
                ...
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous avons détecté une nouvelle connexion à votre compte Artflow.</p>"
                ...
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Cordialement,<br>L'équipe Artflow</p>"
                + "        </div>"
                + "        <div style='text-align: center; padding: 20px; color: #64748b; font-size: 12px;'>"
                + "            <p>Cet email a été envoyé automatiquement, merci de ne pas y répondre.</p>"
                + "            <p>&copy; " + LocalDateTime.now().getYear() + " Artflow. Tous droits réservés.</p>"
                + "        </div>"
                + "    </div>"
                + "</body>"
                + "</html>";
    ...
    private static String createVerificationEmailTemplate(String verificationCode) {
        return "<!DOCTYPE html>"
                ...
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Merci de vous être inscrit sur Artflow !</p>"
    ...
    private static String createPasswordResetTemplate(String prenom, String resetCode) {
        return "<!DOCTYPE html>"
                ...
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Bonjour <strong>" + prenom + "</strong>,</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous avons reçu une demande de réinitialisation de mot de passe pour votre compte Artflow.</p>"
    ...
    private static String createWelcomeEmailTemplate(String prenom) {
        return "<!DOCTYPE html>"
                ...
                + "    <meta charset='UTF-8'>"
                + "    <meta name='viewport' content='width=device-width, initial-scale=1.0'>"
                + "    <title>Bienvenue sur Artflow</title>"
                + "</head>"
                + "<body style='margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f8fafc;'>"
                + "    <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>"
                + "        <div style='background-color: " + PRIMARY_COLOR + "; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;'>"
                ...
                + "        </div>"
                + "        <div style='background-color: white; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);'>"
                + "            <h2 style='color: " + DARK_COLOR + "; margin-top: 0;'>Bienvenue dans la communauté Artflow !</h2>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Bonjour <strong>" + prenom + "</strong>,</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous sommes ravis de vous accueillir sur Artflow, la plateforme dédiée aux artisans et créateurs d'art.</p>"
                ...
                + "                <a href='#' style='background-color: " + SECONDARY_COLOR + "; color: white; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;'>Découvrir Artflow</a>"
                + "            </div>"
    ...
    /**
     * Envoie un email de notification d'approbation de produit à l'artisan
     * @param toEmail L'email du destinataire
     * @param productName Le nom du produit approuvé
     * @param artisanName Le nom de l'artisan
     */
    public static void sendProductApprovalEmail(String toEmail, String productName, String artisanName) {
        LOGGER.info("Préparation de l'envoi d'une notification d'approbation de produit à " + toEmail);
        ...
        try {
            ...
            message.setFrom(new InternetAddress(SENDER_EMAIL, SENDER_NAME));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
            message.setSubject("🎉 Félicitations ! Votre produit a été approuvé");

            // Corps HTML du message
            String htmlContent = createProductApprovalEmailTemplate(productName, artisanName);
            ...
            // Envoi du message
            Transport.send(message);
            LOGGER.info("Email d'approbation de produit envoyé avec succès à " + toEmail);

        } catch (Exception e) {
            LOGGER.severe("Erreur lors de l'envoi de l'email d'approbation: " + e.getMessage());
            e.printStackTrace();
    ...
    /**
     * Envoie un email de notification de refus de produit à l'artisan
     * @param toEmail L'email du destinataire
     * @param productName Le nom du produit refusé
     * @param artisanName Le nom de l'artisan
     */
    public static void sendProductRejectionEmail(String toEmail, String productName, String artisanName) {
        LOGGER.info("Préparation de l'envoi d'une notification de refus de produit à " + toEmail);
        ...
        try {
            ...
            message.setFrom(new InternetAddress(SENDER_EMAIL, SENDER_NAME));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(toEmail));
            message.setSubject("Information concernant votre produit");

            // Corps HTML du message
            String htmlContent = createProductRejectionEmailTemplate(productName, artisanName);
            ...
            // Envoi du message
            Transport.send(message);
            LOGGER.info("Email de refus de produit envoyé avec succès à " + toEmail);

        } catch (Exception e) {
            LOGGER.severe("Erreur lors de l'envoi de l'email de refus: " + e.getMessage());
            e.printStackTrace();
            throw new RuntimeException("Échec de l'envoi de l'email de refus", e);
        }
    }

    /**
     * Crée le template HTML pour l'email d'approbation de produit
     * @param productName Le nom du produit approuvé
     * @param artisanName Le nom de l'artisan
     * @return Le contenu HTML formaté
     */
    private static String createProductApprovalEmailTemplate(String productName, String artisanName) {
        return "<!DOCTYPE html>"
                + "<html lang='fr'>"
                + "<head>"
                + "    <meta charset='UTF-8'>"
                ...
                + "<body style='margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f8fafc;'>"
                + "    <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>"
                + "        <div style='background-color: " + SECONDARY_COLOR + "; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;'>"
                + "            <h1 style='color: white; margin: 0;'>🎉 Bonne nouvelle !</h1>"
                + "        </div>"
                + "        <div style='background-color: white; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);'>"
                + "            <h2 style='color: " + DARK_COLOR + "; margin-top: 0;'>Produit approuvé</h2>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Félicitations <strong>" + artisanName + "</strong> !</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous sommes ravis de vous informer que votre produit <strong style='color: " + SECONDARY_COLOR + ";'>\"" + productName + "\"</strong> a été approuvé par notre équipe d'administration !</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Votre création est maintenant disponible sur notre plateforme et visible par tous nos visiteurs. 🚀</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous sommes convaincus que votre savoir-faire unique va apporter une vraie valeur à notre marketplace d'artisans.</p>"
                + "            <hr style='border: 1px dashed #ddd; margin: 20px 0;'>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Voici ce qui se passe maintenant :</p>"
                + "            <ul style='color: " + DARK_COLOR + "; font-size: 16px;'>"
                ...
                + "            </ul>"
                + "            <div style='margin-top: 20px; padding: 15px; background-color: " + LIGHT_COLOR + "; border-left: 4px solid " + SECONDARY_COLOR + "; border-radius: 3px;'>"
                + "                <p style='margin: 0; color: " + DARK_COLOR + ";'>Si vous avez des questions ou besoin d'assistance, notre équipe de support est disponible 24h/24.</p>"
                + "                <p style='margin: 8px 0 0; color: " + DARK_COLOR + ";'>Contactez-nous par email à <a href='mailto:support@artflow.tn' style='color: " + PRIMARY_COLOR + ";'>support@artflow.tn</a> ou par téléphone au <strong>+216 54 7412 412</strong>.</p>"
                + "            </div>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px; margin-top: 25px;'>Avec nos sincères félicitations,<br>L'équipe Artflow 🧵🔨🎨</p>"
                + "        </div>"
                + "        <div style='text-align: center; padding: 20px; color: #64748b; font-size: 12px;'>"
                + "            <p>Cet email a été envoyé automatiquement, merci de ne pas y répondre.</p>"
                + "            <p>&copy; " + LocalDateTime.now().getYear() + " Artflow. Tous droits réservés.</p>"
    ...
    /**
     * Crée le template HTML pour l'email de refus de produit
     * @param productName Le nom du produit refusé
     * @param artisanName Le nom de l'artisan
     * @return Le contenu HTML formaté
     */
    private static String createProductRejectionEmailTemplate(String productName, String artisanName) {
        return "<!DOCTYPE html>"
                + "<html lang='fr'>"
                + "<head>"
                + "    <meta charset='UTF-8'>"
                ...
                + "    <div style='max-width: 600px; margin: 0 auto; padding: 20px;'>"
                + "        <div style='background-color: " + PRIMARY_COLOR + "; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;'>"
                + "            <h1 style='color: white; margin: 0;'>Information importante</h1>"
                + "        </div>"
                + "        <div style='background-color: white; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);'>"
                + "            <h2 style='color: " + DARK_COLOR + "; margin-top: 0;'>À propos de votre produit</h2>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Bonjour <strong>" + artisanName + "</strong>,</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Nous vous informons que votre produit <strong>\"" + productName + "\"</strong> n'a pas été approuvé par notre équipe d'administration.</p>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Ne vous découragez pas ! Cela arrive souvent et peut être résolu avec quelques ajustements. 💪</p>"
                + "            <hr style='border: 1px dashed #ddd; margin: 20px 0;'>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px;'>Voici les raisons possibles :</p>"
                + "            <ul style='color: " + DARK_COLOR + "; font-size: 16px;'>"
                ...
                + "            </ul>"
                + "            <div style='margin-top: 20px; padding: 15px; background-color: " + LIGHT_COLOR + "; border-left: 4px solid " + PRIMARY_COLOR + "; border-radius: 3px;'>"
                + "                <p style='margin: 0; color: " + DARK_COLOR + ";'><strong>Notre service de réclamation est disponible 24h/24</strong> pour vous aider à comprendre les raisons précises et vous guider pour soumettre à nouveau votre produit.</p>"
                + "                <p style='margin: 8px 0 0; color: " + DARK_COLOR + ";'>Contactez-nous par email à <a href='mailto:reclamation@artflow.tn' style='color: " + PRIMARY_COLOR + ";'>reclamation@artflow.tn</a> ou par téléphone au <strong>+216 54 7412 412</strong>.</p>"
                + "            </div>"
                + "            <p style='color: " + DARK_COLOR + "; font-size: 16px; margin-top: 25px;'>Nous espérons vous aider à réussir prochainement,<br>L'équipe Artflow 🧵🔨🎨</p>"
                + "        </div>"
                + "        <div style='text-align: center; padding: 20px; color: #64748b; font-size: 12px;'>"
                + "            <p>Cet email a été envoyé automatiquement, merci de ne pas y répondre.</p>"
                + "            <p>&copy; " + LocalDateTime.now().getYear() + " Artflow. Tous droits réservés.</p>"
